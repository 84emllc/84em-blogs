...
- Render hook for external links to automatically open in new tabs
- Arrow indicator (↗) to all external links in content

### Changed

- Updated all markdown content with external link arrows
- Documented external link convention in AGENTS.md

## [1.0.5] - 2026-01-09

### Changed

- Footer domain links now open in new tabs
